...
const translations = {
  uk: {
    ...
    js_checklist_names_1_tooltip:
      'Чіткі імена полегшують читання коду та підтримку.',
    ...
    js_checklist_names_2_tooltip:
      'Магічні числа та строки ускладнюють розуміння логіки.',
    ...
    js_checklist_names_3_tooltip:
      'Уникайте імен, які можуть викликати плутанину.',
    ...
    js_checklist_structure_1_tooltip:
      'Один рядок — одна операція для кращої читабельності.',
    ...
    js_checklist_structure_2_tooltip: 'Одна функція — одна відповідальність.',
    ...
    js_checklist_structure_3_tooltip:
      'Менша вкладеність полегшує розуміння логіки.',
    ...
    js_checklist_repetition_1_tooltip:
      'Повторюваний код винось у функції чи утиліти.',
    ...
    js_checklist_repetition_2_tooltip: 'Уніфікований підхід зменшує помилки.',
    ...
    js_checklist_formatting_1_tooltip:
      'Автоматичне форматування забезпечує єдиний стиль.',
    ...
    js_checklist_formatting_2_tooltip:
      'Консистентність стилю полегшує співпрацю.',
    ...
    js_checklist_formatting_3_tooltip:
      'Мертвий код ускладнює підтримку проєкту.',
    ...
    js_checklist_logic_1_tooltip: 'Усі гілки логіки повинні бути протестовані.',
    js_checklist_logic_2: 'Використано <code>===</code>, а не <code>==</code>?',
    js_checklist_logic_2_small: '(Строга рівність уникає помилок)',
    js_checklist_logic_2_tooltip:
      'Строга рівність зменшує неочікувані приведення типів.',
    ...
    js_checklist_logic_3_tooltip:
      'Edge cases можуть викликати помилки в продакшені.',
    ...
    js_checklist_logic_4_tooltip:
      'Асинхронний код потребує обробки помилок через try/catch.',
    ...
    js_checklist_comments_1_tooltip:
      'Коментарі потрібні лише для неочевидної логіки.',
    ...
    js_checklist_comments_2_tooltip:
      'Коментарі повинні пояснювати мету, а не дії коду.',
    ...
    js_checklist_comments_3_tooltip: 'Хороший код самодокументований.',
    ...
    js_checklist_testing_1_tooltip: 'Перевір, що код працює як очікувано.',
    js_checklist_testing_2: 'Не ламає існуючу логіку?',
    js_checklist_testing_2_small: '(Перевір старі функції після змін)',
    js_checklist_testing_2_tooltip:
      'Нові зміни не повинні порушувати старий код.',
    ...
    js_checklist_testing_3_tooltip: 'Тести забезпечують стабільність коду.',
    ...
    js_checklist_security_1_tooltip:
      'Перевір введення користувача на вразливості.',
    ...
    js_checklist_security_2_tooltip:
      'Уникай небезпечних методів, що можуть викликати вразливості.',
    ...
    js_checklist_optimization_1_tooltip:
      'Оптимізація зменшує витрати ресурсів.',
    ...
    js_checklist_optimization_3_tooltip:
      'Строгий режим уникає неочевидних помилок у JS.',
    ...
    php_checklist_structure_1_tooltip: 'Один рядок — одна операція.',
    php_checklist_structure_2: 'Методи невеликі, роблять одне?',
    php_checklist_structure_2_small: '(До 20-30 рядків)',
    php_checklist_structure_2_tooltip: 'Одна функція — одна мета.',
    ...
    php_checklist_repetition_2_tooltip: 'Уніфікація зменшує помилки.',
    ...
    php_checklist_formatting_1_tooltip: 'PSR-12 забезпечує єдиний стиль коду.',
    ...
    php_checklist_formatting_2_tooltip:
      'Консистентний стиль полегшує співпрацю.',
    php_checklist_formatting_3: 'Видалено невикористаний код?',
    php_checklist_formatting_3_small: '(Наприклад, старі функції)',
    php_checklist_formatting_3_tooltip: 'Мертвий код ускладнює підтримку.',
    ...
    php_checklist_comments_1_tooltip: 'Коментарі для неочевидної логіки.',
    php_checklist_comments_2: 'Коментарі пояснюють «чому»?',
    php_checklist_comments_2_small: '(Наприклад, «// Для безпеки»)',
    php_checklist_comments_2_tooltip: 'Пояснюй мету, а не дії.',
    ...
    php_checklist_comments_3_tooltip: 'Самодокументований код кращий.',
    ...
    php_checklist_optimization_2: 'Уникано надмірного використання ресурсів?',
    ...
    py_checklist_names_1_tooltip: 'Чіткі імена полегшують читання.',
    py_checklist_names_2: 'Магічні значення винесені?',
    py_checklist_names_2_small: '(Наприклад, <code>MAX_USERS = 100</code>)',
    py_checklist_names_2_tooltip: 'Константи роблять код зрозумілішим.',
    py_checklist_names_3: 'Немає схожих імен?',
    py_checklist_names_3_small:
      '(Наприклад, <code>user</code> і <code>users</code>)',
    py_checklist_names_3_tooltip: 'Уникайте плутанини в іменах.',
    ...
    py_checklist_structure_1_tooltip: 'Один рядок — одна операція.',
    py_checklist_structure_2: 'Функції невеликі, роблять одне?',
    py_checklist_structure_2_small: '(До 20-30 рядків)',
    py_checklist_structure_2_tooltip: 'Одна функція — одна мета.',
    ...
    py_checklist_repetition_2_tooltip: 'Уніфікація зменшує помилки.',
    ...
    py_checklist_formatting_1_tooltip: 'PEP 8 забезпечує єдиний стиль.',
    ...
    py_checklist_optimization_2: 'Уникано надмірного використання ресурсів?',
  ...
  en: {
    ...
    js_checklist_repetition_1_tooltip:
      'Extract repeated code into functions or utilities.',
    js_checklist_repetition_2: 'Are similar tasks implemented consistently?',
    js_checklist_repetition_2_small:
      '(E.g., date formatting via <code>date-fns</code>)',
    js_checklist_repetition_2_tooltip: 'Consistent approaches reduce errors.',
    ...
    js_checklist_security_1_tooltip: 'Check user input for vulnerabilities.',
    js_checklist_security_2: 'Used safe access methods?',
    js_checklist_security_2_small:
      '(E.g., avoid <code>eval</code> or <code>innerHTML</code>)',
    js_checklist_security_2_tooltip:
      'Avoid unsafe methods that may cause vulnerabilities.',
    ...
    php_checklist_repetition_2_tooltip: 'Consistency reduces errors.',
    php_formatting_legend: '🧼 Formatting',
    php_checklist_formatting_1: 'Followed PSR-12?',
    php_checklist_formatting_1_small:
      "(<a href='https://www.php-fig.org/psr/psr-12/' target='_blank' rel='noopener'>PSR-12</a>)",
    php_checklist_formatting_1_tooltip: 'PSR-12 ensures consistent code style.',
    ...
    php_checklist_security_1_tooltip: 'Protect user data.',
    php_checklist_security_2: 'Used safe methods?',
    php_checklist_security_2_small: '(E.g., <code>htmlspecialchars</code>)',
    php_checklist_security_2_tooltip: 'Avoid unsafe methods.',
    ...
    php_checklist_optimization_1_tooltip: 'Optimization reduces load.',
    php_checklist_optimization_2: 'Avoided excessive resource usage?',
    php_checklist_optimization_2_small: '(Check caching)',
    php_checklist_optimization_2_tooltip: 'Efficient code saves resources.',
    ...
    py_checklist_names_1_tooltip: 'Clear names improve readability.',
    py_checklist_names_2: 'Magic values extracted?',
    py_checklist_names_2_small: '(E.g., <code>MAX_USERS = 100</code>)',
    py_checklist_names_2_tooltip: 'Constants make code clearer.',
    py_checklist_names_3: 'No similar names?',
    py_checklist_names_3_small:
      '(E.g., <code>user</code> and <code>users</code>)',
    py_checklist_names_3_tooltip: 'Avoid confusing names.',
    ...
    py_checklist_repetition_1_tooltip: 'Repeated code complicates maintenance.',
    ...
    py_checklist_repetition_2_tooltip: 'Consistency reduces errors.',
    py_formatting_legend: '🧼 Formatting',
    py_checklist_formatting_1: 'Followed PEP 8?',
    py_checklist_formatting_1_small:
      "(<a href='https://peps.python.org/pep-0008/' target='_blank' rel='noopener'>PEP 8</a>)",
    py_checklist_formatting_1_tooltip: 'PEP 8 ensures consistent style.',
    ...
    py_checklist_optimization_1_tooltip: 'Optimization reduces load.',
    py_checklist_optimization_2: 'Avoided excessive resource usage?',
    py_checklist_optimization_2_small: '(Check caching)',
    py_checklist_optimization_2_tooltip: 'Efficient code saves resources.',
  },
};
...
function updateTranslations(lang) {
  ...
  // Оновлення tooltip для кнопок
  document.querySelectorAll('.tooltip').forEach(button => {
    const key = button.getAttribute('data-translate');
    if (translations[lang][key]) {
      button.setAttribute('data-tooltip', translations[lang][key]);
    }
  });
